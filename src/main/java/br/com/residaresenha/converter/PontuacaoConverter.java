...
@FacesConverter(value = "PontuacaoConverter", forClass = Pontuacao.class)
public class PontuacaoConverter implements Converter {
	
	@Override
    public Object getAsObject(FacesContext arg0, UIComponent arg1, String arg2) {
        if (arg2 != null && !"".equalsIgnoreCase(arg2)) {
        	Pontuacao Pontuacao = (Pontuacao) arg1.getAttributes().get(arg2);
            return Pontuacao;
        }
        return null;
    }
    ...
    public String getAsString(FacesContext context, UIComponent arg1, Object arg2) {
        try {        	
            if (arg2 != null && !"".equals(arg2)) {
            	Pontuacao entity = (Pontuacao) arg2;
